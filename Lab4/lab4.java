...
public class lab4 {
    public static void main(String[] args){
        ...
        RBT<Integer> checker = new RBT<Integer>();
        WrongTree<Integer> wrongTree = new WrongTree<Integer>(64);
        ...
        while (sc.hasNextLine()) {
            ...
            switch(task) {
                ...
                case "test" :
                	...
                	boolean torf = checker.isRBT(wrongTree.getRoot());
                	System.out.println(wrongTree.getTime());
                	if (torf) System.out.println("true");
